        ...
        Column(
            ...
            Row(
                ...
                TextField(
                    ...
                    modifier = Modifier
                        .weight(0.85f)
                        .onFocusChanged { if (it.isFocused) onChangedMessage(userMessage) },
                    enabled = textInputEnabled
                )
                IconButton(
                    onClick = {
                    ...
                    Icon(Icons.AutoMirrored.Default.Send, contentDescription = stringResource(R.string.action_send),
                        tint = Color.White)
                }
            }
        }
...
fun ChatItem(
    ...
    val backgroundColor = when {
        chatMessage.isFromUser -> Color(0xFF97FF85) // 사용자 말풍선
        chatMessage.isThinking -> Color(0xFFD1C4E9) // 생각 중
        else -> Color(0xFFB3E5FC) // 모델 응답
    }
